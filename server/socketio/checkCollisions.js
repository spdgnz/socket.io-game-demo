/**
 * Returns null if no collision, an index if there is a collision
 */
const checkForOrbCollisions = (pData, pConfig, orbs, settings)=>{
    ...
    for (let i = 0; i < orbs.length; i++){
        ...
        // AABB Test(square)  - Axis-aligned bounding boxes (solo per performance)
        if(
            ...
            // console.log("Hit square test!");
                ...
                if(distance < pData.radius + pR){
                    ...
                    if(pData.radius > pR){
                        ...
                        if(pConfig.speed < 6){
                            pConfig.speed += 1; //increase player speed
                        }
